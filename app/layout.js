...
export const metadata = {
  ...
  description:
    "Bahçeşehir diş kliniği FyPlus Dental Clinic. İmplant, zirkonyum kaplama, diş beyazlatma, ortodonti ve gülüş tasarımı alanlarında uzman kadromuzla Bahçeşehir ve Başakşehir bölgesine premium diş sağlığı hizmeti sunuyoruz.",
  keywords: [
    "bahçeşehir diş kliniği",
    "bahçeşehir diş hekimi",
    "implant bahçeşehir",
    "zirkonyum kaplama bahçeşehir",
    "diş beyazlatma bahçeşehir",
    "ortodonti bahçeşehir",
    "gülüş tasarımı bahçeşehir",
    "hollywood smile bahçeşehir",
    "başakşehir diş kliniği",
    "bahçeşehir en iyi diş kliniği",
    "estetik diş hekimliği bahçeşehir",
    "çocuk diş hekimi bahçeşehir",
    "fyplus dental",
  ],
  ...
  openGraph: {
    ...
    description:
      "Bahçeşehir ve Başakşehir bölgesinde implant, zirkonyum, gülüş tasarımı ve estetik diş hekimliği alanlarında premium diş sağlığı hizmeti.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "FyPlus Dental Clinic | Bahçeşehir Diş Kliniği",
    description:
      "Bahçeşehir premium diş kliniği — İmplant, Zirkonyum, Gülüş Tasarımı",
  },
  robots: {
    index: true,
    follow: true,
    ...
    availableService: [
      {
        ...
        description: "Bahçeşehir implant tedavisi",
      },
      {
        "@type": "MedicalProcedure",
        name: "Zirkonyum Kaplama",
        description: "Bahçeşehir zirkonyum kaplama",
      },
      {
        "@type": "MedicalProcedure",
        name: "Ortodonti",
        description: "Bahçeşehir ortodonti tedavisi",
      },
      {
        "@type": "MedicalProcedure",
        name: "Gülüş Tasarımı",
        description: "Bahçeşehir Hollywood Smile gülüş tasarımı",
      },
      {
        "@type": "MedicalProcedure",
        name: "Diş Beyazlatma",
        description: "Bahçeşehir profesyonel diş beyazlatma",
      },
      {
        "@type": "MedicalProcedure",
        name: "Pedodonti",
        description: "Bahçeşehir çocuk diş hekimliği",
      },
    ],
    aggregateRating: {
